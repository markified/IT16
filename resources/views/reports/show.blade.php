            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-info">{{ ucwords(str_replace('_', ' ', $report->report_type)) }}</span></td>
                                </tr>
                                <tr>
                                    <th>Generated By</th>
                    ...
                    <div>
                        ...
                        @elseif($report->report_type == 'stock_out_order')
                        @include('reports.partials.stock_out_order_data')
